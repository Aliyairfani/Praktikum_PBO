    ...
    public static void createTas() throws IOException{
        ...
        switch (pilihan){
            case 1:
                ...
                Sling_Bag newSling = new Sling_Bag(addslingcode, addnama, addnomorseri, addstok, addharga);
            ...
            case 2:
                ...
                Backpack newBackpack = new Backpack(addbackpackcode, addnama2, addnomorseri2, addstok2, addharga2);
                System.out.println("Total harga seluruh barang " + Bia_Bag.Total(addharga2, addstok2));
            ...
            case 3:
                ...
                Hand_Bag newHand = new Hand_Bag(addhandcode, addnama3, addnomorseri3, addstok3, addharga3);
                System.out.println("Total harga seluruh barang " + Bia_Bag.Total(addharga3, addstok3));
        ...
        switch (pilihan){
            case 1:
                ...
                for (int i=0; i<sling_bag.size(); i++){
                    ...
                    System.out.println("Sling Code : " + sling_bag.get(i).getSlingCode());
                    System.out.println("Nama Tas : " + sling_bag.get(i).getNamaTas());
                    System.out.println("Nomor Seri : " + sling_bag.get(i).getNomorSeri());
                    System.out.println("Stok : " + sling_bag.get(i).getStok());
                    System.out.println("Harga : Rp" + sling_bag.get(i).getHarga());
//                    System.out.println("");
                    System.out.println("Total harga seluruh barang " + Bia_Bag.Total(sling_bag.get(i).getHarga(), sling_bag.get(i).getStok()));
                    System.out.println("..........................");
                }
                break;
            case 2:
                ...
                for (int i=0; i<backpack.size(); i++){
                    ...
                    System.out.println("Backpack Code : " + backpack.get(i).getBackpackCode());
                    System.out.println("Nama Tas : " + backpack.get(i).getNamaTas());
                    System.out.println("Nomor Seri : " + backpack.get(i).getNomorSeri());
                    System.out.println("Stok : " + backpack.get(i).getStok());
                    System.out.println("Harga : Rp" + backpack.get(i).getHarga());
                    System.out.println("Total harga seluruh barang " + Bia_Bag.Total(backpack.get(i).getHarga(), backpack.get(i).getStok()));
            ...
            case 3:
                ...
                for (int i=0; i<hand_bag.size(); i++){
                    ...
                    System.out.println("Hand Code : " + hand_bag.get(i).getHandCode());
                    System.out.println("Nama Tas : " + hand_bag.get(i).getNamaTas());
                    System.out.println("Nomor Seri : " + hand_bag.get(i).getNomorSeri());
                    System.out.println("Stok : " + hand_bag.get(i).getStok());
                    System.out.println("Harga : Rp" + hand_bag.get(i).getHarga());
                    System.out.println("Total harga seluruh barang " + Bia_Bag.Total(hand_bag.get(i).getHarga(), hand_bag.get(i).getStok()));
