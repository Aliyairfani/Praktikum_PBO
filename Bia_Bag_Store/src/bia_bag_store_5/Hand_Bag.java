 ...
 * @author aliya
 */
public final class Hand_Bag extends Bia_Bag implements Gudang_Hb {
    ...
    @Override
    public void isAdded(){
        System.out.println("\nTas hand bag baru di input, dengan nama tas " + this.namaTas);
    ...
    public void display(){
        ...
        System.out.println("\nProduksi : " + produksi_Hb());
        System.out.println("Kontak Gudang : " + kontakGudangHb());
    }
    
    public String produksi_Hb(){
        return "Tas ini di produksi oleh PT. FasionParty";
    }
    
    public int kontakGudangHb(){
        return 8736518;
    }
}
