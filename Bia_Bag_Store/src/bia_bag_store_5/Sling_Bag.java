 ...
 * @author aliya
 */
public final class Sling_Bag extends Bia_Bag implements Gudang_Sb {
    ...
    @Override
    public void isAdded(){
        System.out.println("\nTas sling bag baru di input, dengan nama tas " + this.namaTas);
    ...
    public void display(){
        ...
        System.out.println("Kontak Gudang : " + kontakGudangSb());
    }
    
    public String produksi_Sb(){
        return "Tas ini di produksi oleh PT. Fasion";
    }
    
    public int kontakGudangSb(){
        return 2541238; 
    }
}
